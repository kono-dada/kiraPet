    ...
    <v-card flat class="pa-2">
      <v-card-text>
        <div class="mb-8">
          ...
          <div class="mb-6">
            <div class="d-flex justify-space-between align-center mb-3">
              <v-label>显示事件日志</v-label>
              <v-switch
                v-model="ac.showEventLog"
                color="primary"
                density="compact"
                hide-details
              />
...
import { live2dModelService } from 'pages/main/live2d/live2dModelService';
