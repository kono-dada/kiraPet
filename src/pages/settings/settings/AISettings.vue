      ...
      <v-card-text>
        ...
        <div class="mb-8">
          <div class="d-flex justify-space-between align-center mb-4">
            ...
            <v-btn variant="text" size="small" @click="ac.characterPrompt = exampleCharacterPrompt;">
              重置为默认
            </v-btn>
          </div>
          <v-divider class="mb-6"></v-divider>
          ...
          <v-textarea v-model="ac.characterPrompt" label="系统提示词" variant="outlined" rows="6" auto-grow
            hint="定义桌宠的性格和行为规则" persistent-hint></v-textarea>
        </div>
...
import { exampleCharacterPrompt } from '../../../services/agents/default_prompts';
