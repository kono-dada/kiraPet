...
export const AppEvents = {
  ...
  WINDOW_ACTIVE_MINUTE: 'WINDOW_ACTIVE_MINUTE',
...
export interface EventPayloadMap {
  ...
  WINDOW_ACTIVE: { title: string; app_name: string | null; }
  WINDOW_ACTIVE_MINUTE: { total_secs: number; by_title_app: Record<string, number>;};
  TRIGGER_LLM: { prompt: string };
}
